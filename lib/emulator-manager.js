 ...
 */
function launchEmulator(apiLevel, target, arch, profile, cores, ramSize, heapSize, sdcardPathOrSize, diskSize, avdName, forceAvdCreation, emulatorBootTimeout, port, emulatorOptions, disableAnimations, disableSpellChecker, disableLinuxHardwareAcceleration, enableHardwareKeyboard, xvfb, retryCount) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const waitForBootResult = yield (0, retry_1.execWithRetry)(() => __awaiter(this, void 0, void 0, function* () {
                var result = yield (0, retry_1.execWithRetry)(() => exec.exec(cmd, [], {
                    listeners: {
                        stderr: (data) => {
                ...
                if (result !== 0) {
                    ...
                    var pkillResult = yield exec.exec(`pkill qemu-system-x86_64`);
                    console.log(`pkill qemu-system-x86_64 result: ${pkillResult}`);
                    throw new Error('Failed to start AVD.');
                }
                return yield waitForDevice(port, emulatorBootTimeout);
            }), retryCount);
