...
function installAndroidSdk(apiLevel, target, arch, channelId, emulatorBuild, ndkVersion, cmakeVersion, retryCount) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield (0, retry_1.execWithRetry)(() => exec.exec(`sh -c \\"sdkmanager --install 'system-images;android-${apiLevel};${target};${arch}' --channel=${channelId} > android-system-images.log"`), retryCount);
            if (ndkVersion) {
