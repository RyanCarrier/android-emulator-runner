...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // xvfb
            const xvfb = core.getInput('xvfb', { required: true }) === 'true';
            // install SDK
            ...
            // launch an emulator
            try {
                yield (0, emulator_manager_1.launchEmulator)(apiLevel, target, arch, profile, cores, ramSize, heapSize, sdcardPathOrSize, diskSize, avdName, forceAvdCreation, emulatorBootTimeout, port, emulatorOptions, disableAnimations, disableSpellchecker, disableLinuxHardwareAcceleration, enableHardwareKeyboard, xvfb, retryCount);
            }
            catch (error) {
                core.setFailed(error instanceof Error ? error.message : error);
            }
